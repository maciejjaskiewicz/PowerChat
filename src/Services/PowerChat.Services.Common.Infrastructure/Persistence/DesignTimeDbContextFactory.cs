...
namespace PowerChat.Services.Common.Infrastructure.Persistence
{
        ...
        IDesignTimeDbContextFactory<TContext> where TContext : DbContext
    {
        ...
        {
            var configuration = BuildConfigurationRoot(basePath, environmentName);
        ...
        private static IConfigurationRoot BuildConfigurationRoot(string basePath, string environmentName)
        {
